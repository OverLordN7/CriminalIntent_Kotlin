...
class CrimeFragment: Fragment(), DatePickerFragment.Callbacks {
            ...
            viewLifecycleOwner, Observer { crime ->
                crime?.let {
                    ...
                    photoUri = FileProvider.getUriForFile(
                        requireActivity(),
                        "com.example.criminalintent_kotlin.fileprovider",
                        photoFile)
                    updateUI()
                }
            }
    ...
    override fun onStart() {
        ...
        photoButton.apply {
            ...
            // probably camera does not has a DEFAULT filter in intent inside manifest
            // and block the button. Such behavior is wrong for this case.
